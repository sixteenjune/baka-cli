...
local palette = palettes[palette_name] or palettes.ice

for k, v in pairs(palette) do
	M[k] = v
end

M.palettes = palettes -- exposed so the init command can preview them
...
function M.info(msg)
	print(wrap(M.blue, "[baka] ") .. msg)
end
function M.success(msg)
	print(wrap(M.green, "[baka] ") .. msg)
end
function M.warn(msg)
	print(wrap(M.yellow, "[baka] ") .. msg)
end
function M.error(msg)
	print(wrap(M.red, "[baka] ") .. msg)
end
function M.step(msg)
	print(wrap(M.mauve, " -> ") .. msg)
end
